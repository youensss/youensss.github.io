...
BLOG_AUTHOR = "youens"  # (translatable)
BLOG_TITLE = "YOUENS Site"  # (translatable)
...
BLOG_EMAIL = "youensss@foxmail.com"
BLOG_DESCRIPTION = "quietly brilliant"  # (translatable)
